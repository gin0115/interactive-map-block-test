...
module.exports = [
    buildBlockConfig('map'),
    // buildBlockConfig( 'post-feed-events' ),
    // buildBlockConfig( 'store-locator' ),
    // buildBlockConfig( 'store-locator-location' ),
    // buildBlockConfig( 'text-slider' ),
    // buildBlockConfig( 'text-slider-inner' ),
    // buildBlockConfig( 'hidden-content' ),
];